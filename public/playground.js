...
`;
  ...
  var Playground = class {
    constructor(config) {
      ...
      const theme = (_c = this.playgroundElement.getAttribute("data-theme")) != null ? _c : "light";
    ...
    static create(element, code) {
      ...
      return new Playground({
        ...
        server: server != null ? server : "https://play.vlang.foundation/"
      });
    }
